...
Usage (Colab):
  ...
  files.upload()          # upload data/generated/training_data.bin
  !python scripts/training/train.py --data data/generated/training_data.bin --epochs 20 --out models/model.pt
"""
...
class AppleDataset(Dataset):
    """
    Reads the binary file produced by `go run ./cmd/apple-game -gen`.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data",    default="data/generated/training_data.bin", help="binary training file")
    parser.add_argument("--out",     default="models/model.pt",                  help="output checkpoint path")
