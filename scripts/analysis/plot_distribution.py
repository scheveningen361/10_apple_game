...
Reads data/raw/greedy_100k.txt and generates distribution plots
"""
...
plt.tight_layout()
plt.savefig('reports/figures/greedy_distribution.png', dpi=150, bbox_inches='tight')
print("✓ Graph saved: reports/figures/greedy_distribution.png")
plt.show()
