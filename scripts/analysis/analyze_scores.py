#!/usr/bin/env python3
"""
Parse data/raw/games_1000.txt and generate score distribution summary.
"""

from collections import Counter
import re

# Read data/raw/games_1000.txt
...
# Write to file
with open('reports/score_distribution.txt', 'w') as f:
...
print("✓ 점수별 분포 저장: reports/score_distribution.txt")
with open('reports/score_distribution.txt', 'r') as f:
    print("\n" + f.read())
