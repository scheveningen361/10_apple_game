#!/usr/bin/env python3
"""
Apple Game Greedy 100K Distribution Analysis
"""
...
# Read scores
try:
    scores = np.loadtxt('data/raw/greedy_100k.txt', dtype=int)
except FileNotFoundError:
    print("Error: data/raw/greedy_100k.txt not found")
    sys.exit(1)
...
stats_text = f"""
STATISTICS SUMMARY (Greedy, 100K games)
{'='*40}
...
plt.tight_layout()
plt.savefig('reports/figures/greedy_distribution_100k.png', dpi=150, bbox_inches='tight')
print("Graph saved: reports/figures/greedy_distribution_100k.png")

# Print summary
print("\n" + "="*50)
print("STATISTICS SUMMARY (Greedy, 100K games)")
print("="*50)
