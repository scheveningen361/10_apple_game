...
plt.tight_layout()
plt.savefig('reports/figures/record_bucket_distribution_v2.png', dpi=150, bbox_inches='tight')
print("\nSaved: reports/figures/record_bucket_distribution_v2.png")
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig('reports/figures/record_label_histogram_v2.png', dpi=150, bbox_inches='tight')
print("Saved: reports/figures/record_label_histogram_v2.png")
