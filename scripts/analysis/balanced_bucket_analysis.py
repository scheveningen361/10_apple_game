...
# Parse scores from data/raw/games_1000.txt
...
plt.tight_layout()
plt.savefig('reports/figures/balanced_bucket_distribution.png', dpi=150, bbox_inches='tight')
print("\nSaved: reports/figures/balanced_bucket_distribution.png")
