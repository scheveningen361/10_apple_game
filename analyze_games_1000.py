...
Reads games_1000.txt, extracts scores, and generates visualizations
"""
...
try:
    ...
    print("Error: games_1000.txt not found")
    sys.exit(1)
...
plt.tight_layout()
plt.savefig('ana_distribution_1000.png', dpi=150, bbox_inches='tight')
print("✓ Graph saved: ana_distribution_1000.png")
