...
# Read scores
try:
    scores = np.loadtxt('random_100k.txt', dtype=int)
except FileNotFoundError:
    print("Error: random_100k.txt not found")
    sys.exit(1)
...
plt.tight_layout()
plt.savefig('random_distribution_100k.png', dpi=150, bbox_inches='tight')
print("Graph saved: random_distribution_100k.png")
