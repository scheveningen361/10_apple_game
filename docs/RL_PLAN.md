...
Phase 1: SL 데이터 생성 (Go)  ✅
  ...
  명령: go run ./cmd/apple-game -gen-sl 500 -sl-out data/generated/sl_data.bin
...
Phase 4: 통합 평가 (Go + ONNX)  ✅ (playModelAnA + runModelAnAvsAnA 완성)
  명령: go run -tags nn ./cmd/apple-game -nn-ana -n 100 -model models/model_rl.onnx -ort-lib runtime/onnxruntime.dll
