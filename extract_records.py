...
plt.tight_layout()
plt.savefig('record_bucket_distribution.png', dpi=150, bbox_inches='tight')
print("\nSaved: record_bucket_distribution.png")
...
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig('record_label_histogram.png', dpi=150, bbox_inches='tight')
print("Saved: record_label_histogram.png")
