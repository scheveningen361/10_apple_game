...
try:
    greedy = np.loadtxt('greedy_100k.txt', dtype=int)
    random = np.loadtxt('random_100k.txt', dtype=int)
except FileNotFoundError as e:
    print(f"Error loading file: {e}")
    sys.exit(1)

# Parse AnA from games_1000.txt (it has different format)
try:
...
plt.tight_layout()
plt.savefig('comparison_all_strategies.png', dpi=150, bbox_inches='tight')
print("Graph saved: comparison_all_strategies.png")
