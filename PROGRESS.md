...
go run . -rana -k 3 -n 100

# AnA 단독 벤치마크
go run . -ana-only -n 1000 -ana-out games_1000.txt

# Greedy 대규모 벤치마크
go run . -greedy-bench -n 100000 -greedy-out greedy_scores.txt
...
# 170점 퍼펙트 탐색
go run . -perfect -perfect-out perfect_game.txt
